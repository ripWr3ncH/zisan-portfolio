  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M16 4C9.37 4 4 9.37 4 16C4 22.63 9.37 28 16 28C22.62 28 28 22.63 28 16C28 9.37 22.62 4 16 4ZM23.94 10.85C25.1 12.3 25.8 14.11 25.83 16.07C25.53 16.01 22.43 15.38 19.3 15.77C19.23 15.61 19.17 15.44 19.1 15.27C18.93 14.87 18.74 14.47 18.55 14.09C22 12.67 23.73 11.12 23.94 10.85ZM16 6.18C18.11 6.18 20.05 6.95 21.56 8.22C21.38 8.47 19.82 9.91 16.5 11.18C14.96 8.37 13.27 6.06 13.01 5.72C14 5.37 15 5.18 16 5.18V6.18ZM10.75 6.69C11 7.01 12.66 9.33 14.23 12.08C9.83 13.26 5.93 13.24 5.53 13.24C6.19 10.24 8.16 7.72 10.75 6.69ZM6.17 16.01C6.17 15.92 6.17 15.83 6.17 15.74C6.56 15.75 11.13 15.8 15.87 14.41C16.15 14.95 16.41 15.51 16.66 16.06C16.53 16.1 16.39 16.14 16.26 16.18C11.37 17.74 8.77 22.06 8.55 22.43C7.09 20.91 6.17 18.88 6.17 16.65V16.01ZM16 26.84C14.07 26.84 12.27 26.22 10.8 25.17C10.97 24.82 12.93 21.07 18.3 19.2C18.32 19.19 18.33 19.19 18.35 19.18C19.68 22.63 20.21 25.52 20.37 26.44C18.99 26.84 17.56 27.04 16 27.04V26.84ZM22.49 25.37C22.38 24.73 21.89 21.97 20.65 18.57C23.61 18.11 26.21 18.86 26.52 18.96C26.06 21.65 24.55 23.98 22.49 25.37Z"
        fill="currentColor"
      />
    </svg>
  );
...
export function TelegramIcon(props: IconProps) {
  return (
    ...
    >
      <path
        d="M16 4C9.37 4 4 9.37 4 16C4 22.63 9.37 28 16 28C22.63 28 28 22.63 28 16C28 9.37 22.63 4 16 4ZM21.87 12.21L20.11 20.81C19.98 21.45 19.59 21.62 19.05 21.31L16.05 19.08L14.6 20.47C14.45 20.62 14.32 20.75 14.03 20.75L14.22 17.69L19.78 12.66C20.03 12.44 19.72 12.31 19.39 12.54L12.55 16.88L9.59 15.96C8.97 15.76 8.96 15.32 9.72 14.99L21.08 10.73C21.6 10.54 22.05 10.86 21.87 11.65V12.21Z"
        fill="currentColor"
      />
    </svg>
  );
